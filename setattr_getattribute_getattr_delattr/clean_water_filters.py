# Объявите класс GeyserClassic - фильтр для очистки воды. В этом классе должно быть три слота для фильтров. Каждый
# слот строго для своего класса фильтра:
#
...
# объекты класса Mechanical, во второй - объекты класса Aragon и в третий - объекты класса Calcium. Иначе слот должен
# оставаться пустым.
#
...
#
# - все три фильтра установлены в слотах; - все фильтры работают в пределах срока службы (значение (time.time() -
# date) должно быть в пределах [0; MAX_DATE_FILTER])
